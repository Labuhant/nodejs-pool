...
function calculatePPLNSPayments(blockHeader) {
    ...
    async.doWhilst(function (callback) {
        ...
        console.log("PPLNS payout cycle complete on block: " + blockHeader.height + " Block Value: " + global.support.coinToDecimal(blockHeader.reward) + " Block Payouts: " + global.support.coinToDecimal(totalPayments) + " Payout Percentage: " + (totalPayments / blockHeader.reward) * 100 + "% (precisely " + totalPayments + " / " + blockHeader.reward + ")");
    });
};
